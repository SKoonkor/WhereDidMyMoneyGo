...
const TH: Record<string, string> = {
  ...
  'Go to {section}?': 'ไปที่ {section} หรือไม่?',
  'Open the full {section} page?': 'เปิดหน้า {section} แบบเต็มหรือไม่?',
  Open: 'เปิด',
  fixed: 'คงที่',
  ...
  '(this version)': '(เวอร์ชันนี้)',
  New: 'ใหม่',
  Improved: 'ปรับปรุง',
  Fixed: 'แก้ไข',
  Removed: 'นำออก',
  'Version history — see what changed in each update, right here in Settings.': 'ประวัติเวอร์ชัน — ดูว่ามีอะไรเปลี่ยนแปลงบ้างในแต่ละอัปเดต ได้ที่หน้าตั้งค่านี้',
  'Clearer wording in the first-run tour, plus a tip that you can scan a receipt with AI by holding the ＋ button.': 'ปรับถ้อยคำในทัวร์แนะนำการใช้งานให้ชัดเจนขึ้น พร้อมเพิ่มคำแนะนำว่าสามารถให้ AI ช่วยสแกนใบเสร็จได้ด้วยการกดปุ่ม ＋ ค้างไว้',
  '“Add to home screen” guide now warns if you opened the app inside another app’s browser (like Instagram or Facebook) and shows how to reopen it in Safari or Chrome.': 'คู่มือ “เพิ่มลงหน้าจอหลัก” จะแจ้งเตือนหากคุณเปิดแอปจากเบราว์เซอร์ในแอปอื่น (เช่น Instagram หรือ Facebook) และบอกวิธีเปิดใหม่ใน Safari หรือ Chrome',
  'First public beta.': 'รุ่นเบต้าสาธารณะรุ่นแรก',
  'Track income, expenses, and transfers — all stored on your device.': 'บันทึกรายรับ รายจ่าย และการโอน — เก็บไว้บนอุปกรณ์ของคุณทั้งหมด',
  'Insights & planners: Income/Expense, Money Flow, Budget, Financial Goals, Income Tax, and Retirement.': 'ข้อมูลเชิงลึกและเครื่องมือวางแผน: รายรับ/รายจ่าย, กระแสเงิน, งบประมาณ, เป้าหมายการเงิน, ภาษีเงินได้ และการเกษียณ',
  'Import from other money apps (CSV or Excel), plus full export, backup, and restore.': 'นำเข้าข้อมูลจากแอปการเงินอื่น (CSV หรือ Excel) พร้อมส่งออก สำรอง และกู้คืนข้อมูลได้ครบถ้วน',
  'AI receipt scanning using your own API key (optional).': 'สแกนใบเสร็จด้วย AI โดยใช้คีย์ API ของคุณเอง (ไม่บังคับ)',
  'Daily reminders, English/Thai, light/dark theme, and a hide-amounts privacy toggle.': 'การแจ้งเตือนรายวัน, ภาษาอังกฤษ/ไทย, ธีมสว่าง/มืด และปุ่มซ่อนจำนวนเงินเพื่อความเป็นส่วนตัว',
  'Installable as an app, works offline, and your data never leaves your device.': 'ติดตั้งเป็นแอปได้ ใช้งานออฟไลน์ได้ และข้อมูลของคุณไม่ออกไปจากเครื่องเลย',
  Accounts: 'บัญชี',
  Categories: 'หมวดหมู่',
  Rename: 'เปลี่ยนชื่อ',
