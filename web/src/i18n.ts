...
const TH: Record<string, string> = {
  ...
  'This app is built by one person and is free to use. If it helps you, a coffee, a follow, or a hello means a lot — thank you!': 'แอปนี้พัฒนาโดยคนคนเดียวและใช้งานฟรี ถ้ามันมีประโยชน์กับคุณ ไม่ว่าจะเลี้ยงกาแฟ กดติดตาม หรือทักทายสักคำ ก็มีความหมายมาก — ขอบคุณครับ!',
  ...
  'Tap the big ＋ in the middle of the bar to add an expense or income. Fill in the amount, pick a category and account, and save. That’s the core loop.': 'แตะปุ่ม ＋ ตรงกลางแถบเพื่อเพิ่มรายจ่ายหรือรายรับ ใส่จำนวนเงิน เลือกหมวดหมู่และบัญชี แล้วบันทึก เท่านี้ก็เสร็จ',
  ...
  'The Apps tab holds your insights — Income & Expense breakdowns, Money Flow, Budget and Goals — plus planners like Retirement, Compound Interest and Income Tax.': 'แท็บแอปรวมข้อมูลเชิงลึก — สัดส่วนรายรับรายจ่าย, กระแสเงิน, งบประมาณ และเป้าหมาย — พร้อมเครื่องมือวางแผน เช่น การเกษียณ ดอกเบี้ยทบต้น และภาษีเงินได้',
  ...
  'Bring your history with you: Settings → Import reads a CSV or Excel export from another money app, with ready-made templates for popular ones.': 'นำประวัติเดิมมาด้วย: ตั้งค่า → นำเข้า อ่านไฟล์ CSV หรือ Excel จากแอปการเงินอื่น พร้อมเทมเพลตสำเร็จรูปสำหรับแอปยอดนิยม',
