...
const TH: Record<string, string> = {
  ...
  'Take or choose a photo of the receipt': 'ถ่ายหรือเลือกรูปใบเสร็จ',
  Retake: 'ถ่ายใหม่',
  ...
  'Add Money Tracker to your home screen to open it like a normal app — full-screen, offline, and one tap away. It stays completely on your device.': 'เพิ่ม Money Tracker ลงหน้าจอหลักเพื่อเปิดใช้เหมือนแอปทั่วไป — เต็มจอ ใช้ออฟไลน์ได้ และเปิดได้ในแตะเดียว ข้อมูลทั้งหมดยังอยู่บนเครื่องของคุณ',
